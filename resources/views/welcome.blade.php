<x-app-layout>
    ...
    <div class="bg-[#F9F3EE] min-h-screen">
        ...
        <div id="cookie-banner" class="fixed bottom-4 right-4 bg-[#E67E22] text-white p-4 rounded-lg shadow-lg max-w-sm z-50 flex flex-col gap-4">
            <p class="text-sm">
                ...
                <a href="{{ url('/reglementation') }}" class="underline font-bold text-white hover:text-gray-200">
                    Consulter notre politique des cookies
                </a>
            </p>
            <div class="flex gap-2 justify-end">
                <button onclick="acceptCookies()" class="bg-white text-[#E67E22] px-3 py-1 rounded font-bold hover:bg-gray-100 transition">
                    Accepter
                </button>
                <button onclick="declineCookies()" class="bg-gray-200 text-[#E67E22] px-3 py-1 rounded font-bold hover:bg-gray-300 transition">
                    Refuser
                </button>
            </div>
        </div>
            ...
            <div id="healthy-chat-window" class="fixed bottom-24 right-6 w-80 md:w-96 h-[500px] bg-white rounded-2xl shadow-2xl z-[999] hidden flex-col overflow-hidden border border-gray-100 font-sans">
                ...
                <div class="bg-[#F37021] p-4 text-white flex justify-between items-center">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div class="w-10 h-10 bg-white rounded-full flex items-center justify-center text-[#F37021] font-bold">
                            HD
                        </div>
                ...
                <div class="p-4 border-t bg-white flex gap-2">
                    ...
                    <input type="text"
                           ...
                           class="flex-1 bg-gray-100 rounded-full px-4 py-2 text-sm outline-none focus:ring-1 focus:ring-[#F37021]">
    ...
    <script>
        ...
        function acceptCookies() {
            ...
            document.cookie = "demo_lore_cookie=accepted; path=/; max-age=31536000";
        }
